...
class booked_tripController extends Controller
{
    ...
    {
        $booked_trip = Booked_Trip::orderBy('date','ASC')->get();
    ...
    public function store(Request $request)
    {
      $this->validate($request,[
        ...
        $booked_trip->status = $request->status?'Done':'Not done';
        $booked_trip->save();
    ...
    {
        $notvalid= $this->validate($request,[
            'date' => 'required',
            'location' => 'required',
            'start_time' => 'required',
            'end_time' => 'required',
         ...
         $booked_trip->end_time = $request->end_time;
           $booked_trip->bus_id = $request->bus_id;
            $booked_trip->driver_id = $request->driver_id;
             $booked_trip->helper_id = $request->helper_id;
             if ($request->status) {
                $booked_trip->status ='Done';
             }
             else{
                 $booked_trip->status ='Not Done';
             }
            // $booked_trip->status = $request->status?'Done':'not done';
        $booked_trip->save();
