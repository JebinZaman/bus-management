				...
				<form action="{{ route('booked_trip.update',$booked_trip->id) }}" method="post">
				  ...
				  <div class="form-group">
				   ...
				   <div class="form-group">
				    ...
				    <select class="form-control" name="bus_id" required="true">
				    ...
				    <select class="form-control" name="driver_id" required="true">
				  ...
				  <div class="form-group">
				    ...
				    <select class="form-control" name="helper_id" required="true">
				    	<option value="">Please select a helper</option>
				  ...
				  <div class="form-check">
				    <input type="checkbox" class="form-check-input" id="exampleCheck1" name="status" {{$booked_trip->status=="Done"?'checked':''}}>
